...
const HomePage = () => {
  return (
    <div
      className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-cover bg-center relative"
      ...
      <div className="w-full md:w-1/2 text-left relative z-10 p-4">
        ...
        <div className="flex flex-col md:flex-row mt-6">
          <div className="flex gap-4">
            <Link href="/users">
              <span className="bg-[#7B7460] text-white px-6 py-3 rounded-xl mb-2 md:mb-0 md:ml-2 hover:bg-[#7f7b6f] transition duration-300">
                Ver Usuários
              </span>
            </Link>
          </div>
